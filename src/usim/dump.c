...
void dumpCPUReg()
{
    ...
    printMemEntry4(STR_PCLATH, PCLATH, STR_INTCON, INTCON, STR_OPTION_REG, OPTION_REG, STR_TRISA, GPIO_TRISA);
    printMemEntry3(STR_TRISB, GPIO_TRISB, STR_EECON1, EECON1, STR_EECON2, EECON2);
    drawSeperator("");
